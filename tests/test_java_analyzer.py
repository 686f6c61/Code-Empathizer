...
'''
        ...
        assert metrics['documentacion']['cobertura'] >= 0.5  # At least 1 method documented
...
'''
        metrics = analyzer.analyze_file('Test.java', simple_code)
        assert 'consistencia_estilo' in metrics