...
'''
        ...
        # asyncArrow may or may not be detected depending on regex
...
'''
        ...
        assert metrics['documentacion']['cobertura'] >= 0.5  # At least 1 function documented
...
'''
        ...
        # Both should have consistency metrics
        assert 'consistencia_estilo' in consistent_metrics
        assert 'consistencia_estilo' in inconsistent_metrics
