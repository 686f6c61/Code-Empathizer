...
"""
=============================================================================
Módulo de Análisis Paralelo - Procesamiento Concurrente de Archivos
=============================================================================

Este módulo implementa análisis paralelo de código utilizando multiprocessing
para aprovechar múltiples núcleos de CPU y acelerar el procesamiento de
repositorios grandes.

ESTRATEGIA DE PARALELIZACIÓN:
----------------------------
- Agrupación de archivos por lenguaje de programación
- Análisis paralelo por grupos de lenguaje
- Pool de workers basado en ProcessPoolExecutor
...
-------------------------
- Reducción de tiempo proporcional al número de núcleos
- Mejor uso de recursos del sistema
- Escalable para repositorios muy grandes
- Procesamiento aislado por proceso (sin GIL)
...
--------------
    ...
    >>>
    >>> # Análisis por lotes para repositorios grandes
    >>> results = analyzer.analyze_files_batch(files, batch_size=50)

NOTAS TÉCNICAS:
--------------
- Usa ProcessPoolExecutor para verdadero paralelismo (evita GIL)
- Los datos se serializan entre procesos (overhead para archivos grandes)
- El número óptimo de workers depende del tipo de análisis y CPU
...
# IMPORTACIONES
# =============================================================================
import multiprocessing as mp                                  # Info de CPU
