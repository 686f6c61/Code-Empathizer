...
"""
=============================================================================
Analizador Local - Clonación de Repositorios para Análisis Rápido
=============================================================================

Este módulo implementa un analizador que clona repositorios Git temporalmente
en el sistema local para realizar análisis más rápidos y completos que los
que permite la API de GitHub.

VENTAJAS DEL ANÁLISIS LOCAL:
---------------------------
- Sin límites de rate limiting de GitHub
- Acceso a todos los archivos sin restricciones
- Análisis más rápido para repositorios grandes
- No requiere token de GitHub para repos públicos

PROCESO DE ANÁLISIS:
-------------------
1. Crear directorio temporal único
2. Clonar repositorio con git clone --depth 1
3. Filtrar archivos por extensiones soportadas
4. Analizar cada archivo con el analizador correspondiente
5. Agregar métricas de todos los archivos
6. Limpiar directorio temporal

ESTRUCTURA TEMPORAL:
-------------------
/tmp/repo_empathizer_temp/
├── repo_<timestamp>/
...
- Usa espacio en disco para el clon temporal
- Archivos > 5MB son ignorados por defecto
- Directorios node_modules, .git, etc. son excluidos
...
--------------
    ...
    >>> metrics = analyzer.analyze_repo("https://github.com/user/repo")
...
import subprocess                    # Ejecución de comandos del sistema (git)
