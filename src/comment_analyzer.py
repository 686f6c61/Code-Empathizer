...
"""
=============================================================================
Analizador de Comentarios y Marcadores TODO/FIXME
=============================================================================

Este módulo analiza la calidad y cantidad de comentarios en el código fuente,
así como marcadores especiales que indican trabajo pendiente o problemas.

TIPOS DE COMENTARIOS ANALIZADOS:
-------------------------------
Por lenguaje:
    - Python: # comentario, \"\"\"docstring\"\"\"
    - JavaScript/Java/C++/C#/Go: // comentario, /* */ multilínea
    - Ruby: # comentario, =begin...=end
    - PHP: # o // comentario, /* */ multilínea

MARCADORES ESPECIALES DETECTADOS:
--------------------------------
    TODO (medium)     - Tareas pendientes
    FIXME (high)      - Código que necesita reparación
    HACK (high)       - Soluciones temporales o feas
    BUG (critical)    - Errores conocidos
    XXX (high)        - Advertencia importante
    OPTIMIZE (medium) - Mejoras de rendimiento pendientes
    NOTE (low)        - Notas informativas
    DEPRECATED (high) - Código obsoleto

EVALUACIÓN DE CALIDAD DE COMENTARIOS:
------------------------------------
Comentarios obvios (penalizan):
    - "increment", "decrement", "add one"
    - "get value", "set value", "return result"

Comentarios significativos (bonifican):
    - Explicaciones de "why", "because", "reason"
    - Referencias a algoritmos o documentación
    - Advertencias importantes

Code smells en comentarios (penalizan):
    - "don't touch", "magic number", "temporary fix"
    - "not sure", "maybe", "probably"

MÉTRICAS CALCULADAS:
-------------------
- total_comments: Número total de comentarios
- comment_ratio: % de líneas comentadas
- documentation_coverage: % de funciones documentadas
- avg_comment_length: Longitud promedio de comentarios
- markers: Marcadores por tipo (TODO, FIXME, etc.)
- comment_score: Puntuación de calidad (0-100)

RATIO ÓPTIMO DE COMENTARIOS:
---------------------------
- < 5%:   Muy bajo - Falta documentación
- 5-10%:  Bajo - Considerar añadir comentarios
- 10-25%: Óptimo - Buen balance
- 25-35%: Alto - Posiblemente excesivo
- > 35%:  Muy alto - Revisar necesidad
...
--------------
    ...
    >>> files = {"main.py": "# TODO: Implementar cache\ndef foo():..."}
    >>> results = analyzer.analyze_comments(files)
    >>>
    >>> print(f"TODOs encontrados: {len(results['markers']['todo'])}")
    >>> print(f"Ratio de comentarios: {results['comment_metrics']['comment_ratio']}%")
