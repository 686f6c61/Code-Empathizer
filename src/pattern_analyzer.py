...
Este módulo detecta patrones de diseño (Design Patterns) y anti-patrones en
el código fuente, evaluando la calidad arquitectónica del proyecto.

PATRONES DE DISEÑO DETECTADOS:
-----------------------------
Creacionales:
    - Singleton: Una única instancia de una clase
    - Factory: Creación de objetos sin especificar clase exacta

Estructurales:
    - Decorator: Añadir funcionalidad dinámicamente
    - Adapter: Convertir interfaz de una clase

Comportamentales:
    - Observer: Notificación de cambios a suscriptores
    - Strategy: Familia de algoritmos intercambiables

ANTI-PATRONES DETECTADOS:
------------------------
- God Class: Clases muy grandes (>500 líneas, >20 métodos)
- Spaghetti Code: Código con anidamiento muy profundo
- Copy-Paste: Código duplicado excesivo
- Magic Numbers: Números sin nombrar en el código
- Long Method: Métodos >50 líneas

ANÁLISIS DE ESTRUCTURA:
----------------------
Detecta patrones arquitectónicos como:
...
MÉTRICAS CALCULADAS:
-------------------
- design_patterns: Patrones encontrados con ubicaciones
- anti_patterns: Anti-patrones con severidad
- structure_analysis: Tipo de arquitectura detectada
- pattern_score: Puntuación de calidad (0-100)
...
--------------
    ...
    >>> files = {"service.py": "class UserFactory:..."}
    >>> results = analyzer.analyze_patterns(files)
    >>>
    >>> print(f"Patrones: {list(results['design_patterns'].keys())}")
    >>> print(f"Anti-patrones: {list(results['anti_patterns'].keys())}")
    >>> print(f"Score: {results['pattern_score']}")

INTERPRETACIÓN DEL SCORE:
------------------------
- >= 80: Excelente uso de patrones de diseño
- 60-79: Buen uso con áreas de mejora
- < 60: Se recomienda revisar la arquitectura
...
from typing import Dict, List, Any, Set  # Type hints
