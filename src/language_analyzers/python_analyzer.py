...
Este módulo implementa un analizador especializado para código Python
utilizando el módulo AST (Abstract Syntax Tree) de la biblioteca estándar.

VENTAJAS DEL ANÁLISIS AST:
-------------------------
- Análisis sintáctico preciso sin ejecutar el código
- Detección de estructuras de código a nivel de árbol
- Acceso a información de líneas y columnas
- Análisis de docstrings y anotaciones de tipo

CONVENCIONES PYTHON EVALUADAS:
-----------------------------
PEP 8 - Style Guide:
...
PEP 257 - Docstrings:
    ...
    - Formato consistente de documentación
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.python_analyzer import PythonAnalyzer
    >>>
    >>> analyzer = PythonAnalyzer()
    >>> metrics = analyzer.analyze_file("main.py", source_code)
    >>> print(f"Descriptividad: {metrics['nombres']['descriptividad']}")
...
# IMPORTACIONES
# =============================================================================
import ast                           # Abstract Syntax Tree de Python
