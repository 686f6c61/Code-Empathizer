...
regulares para detectar patrones del lenguaje y framework .NET.

EXTENSIONES SOPORTADAS:
----------------------
- .cs - Archivos fuente de C#
...
CONVENCIONES DE C# EVALUADAS:
----------------------------
Nombres (.NET Naming Guidelines):
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.csharp_analyzer import CSharpAnalyzer
    >>>
    >>> analyzer = CSharpAnalyzer()
    >>> metrics = analyzer.analyze_file("Program.cs", source_code)
