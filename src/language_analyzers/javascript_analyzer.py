...
"""
=============================================================================
Analizador de Código JavaScript - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código JavaScript utilizando
expresiones regulares optimizadas para detectar patrones comunes.

EXTENSIONES SOPORTADAS:
----------------------
- .js   - JavaScript estándar
- .jsx  - JavaScript con JSX (React)
- .mjs  - JavaScript modules (ES6+)

CARACTERÍSTICAS DE JAVASCRIPT ANALIZADAS:
----------------------------------------
ES6+ Features:
    - Arrow functions (=>)
...
--------------------
- Uso de const/let vs var
- Arrow functions vs function
- Async/await vs callbacks
- ES6+ features coverage
- JSX complexity

PATRONES DETECTADOS:
-------------------
Positivos:
    - Uso de const para inmutabilidad
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.javascript_analyzer import JavaScriptAnalyzer
    >>>
    >>> analyzer = JavaScriptAnalyzer()
    >>> metrics = analyzer.analyze_file("app.js", source_code)
