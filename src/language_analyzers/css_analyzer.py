...
"""
=============================================================================
Analizador de Código CSS - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código CSS y preprocesadores,
evaluando organización, especificidad, y mejores prácticas de estilos.
...
CARACTERÍSTICAS DE CSS ANALIZADAS:
---------------------------------
Selectores:
    - Tipo de selectores (clase, id, etiqueta)
    - Especificidad
    - Combinadores
...
---------------------------
- specificity_avg: Especificidad promedio
- selector_complexity: Complejidad de selectores
- modern_features: Uso de CSS moderno
- duplication: Código duplicado
- organization: Estructura y organización
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.css_analyzer import CSSAnalyzer
    >>>
    >>> analyzer = CSSAnalyzer()
    >>> metrics = analyzer.analyze_file("styles.css", source_code)
    >>> print(f"Especificidad promedio: {metrics['specificity_avg']}")
