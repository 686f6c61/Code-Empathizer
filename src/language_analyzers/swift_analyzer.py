...
"""
=============================================================================
Analizador de Código Swift - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código Swift utilizando expresiones
regulares para detectar patrones de desarrollo iOS/macOS.

EXTENSIONES SOPORTADAS:
----------------------
- .swift - Archivos Swift

CARACTERÍSTICAS DE SWIFT ANALIZADAS:
-----------------------------------
Tipos:
...
Concurrencia (Swift 5.5+):
    - async/await
    - actors
    - Task groups

CONVENCIONES DE SWIFT EVALUADAS:
-------------------------------
Swift API Design Guidelines:
    - camelCase para funciones, propiedades
...
Documentación:
    ...
    - Markup: - Parameters:, - Returns:, - Throws:

MÉTRICAS ESPECÍFICAS DE SWIFT:
-----------------------------
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.swift_analyzer import SwiftAnalyzer
    >>>
    >>> analyzer = SwiftAnalyzer()
    >>> metrics = analyzer.analyze_file("ViewController.swift", source_code)
