...
"""
=============================================================================
Analizador de Código Java - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código Java utilizando expresiones
regulares para detectar patrones y estructuras típicas del lenguaje.

EXTENSIONES SOPORTADAS:
----------------------
- .java - Archivos fuente de Java

CARACTERÍSTICAS DE JAVA ANALIZADAS:
----------------------------------
Estructura:
    - Clases e interfaces
    - Enums
...
MÉTRICAS ESPECÍFICAS DE JAVA:
----------------------------
- Uso de Optional vs null
- Streams vs loops tradicionales
...
Negativos:
    - God classes
    - Instanceof chains
    - Raw types (sin genéricos)

EJEMPLO DE USO:
--------------
    >>> from language_analyzers.java_analyzer import JavaAnalyzer
    >>>
    >>> analyzer = JavaAnalyzer()
    >>> metrics = analyzer.analyze_file("Main.java", source_code)
