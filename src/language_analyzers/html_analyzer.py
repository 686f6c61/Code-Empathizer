...
"""
=============================================================================
Analizador de Código HTML - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código HTML evaluando estructura,
semántica, accesibilidad y mejores prácticas de marcado.
...
CARACTERÍSTICAS DE HTML ANALIZADAS:
----------------------------------
Estructura:
    - DOCTYPE declaration
...
MÉTRICAS ESPECÍFICAS DE HTML:
----------------------------
- semantic_score: % de uso de etiquetas semánticas
- accessibility_score: Cumplimiento WCAG
- structure_score: Estructura correcta del documento
- meta_completeness: Completitud de meta tags
- form_accessibility: Accesibilidad de formularios
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.html_analyzer import HTMLAnalyzer
    >>>
    >>> analyzer = HTMLAnalyzer()
    >>> metrics = analyzer.analyze_file("index.html", source_code)
    >>> print(f"Accessibility: {metrics['accessibility_score']}")
...
from .base import LanguageAnalyzer   # Clase base de analizadores
