...
"""
=============================================================================
Analizador de Código Ruby - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código Ruby utilizando expresiones
regulares para detectar patrones idiomáticos del lenguaje.

EXTENSIONES SOPORTADAS:
----------------------
- .rb      - Archivos Ruby estándar
- .rake    - Archivos Rake
- .gemspec - Especificaciones de gemas

CARACTERÍSTICAS DE RUBY ANALIZADAS:
----------------------------------
Estructura:
    - Classes y modules
...
CONVENCIONES DE RUBY EVALUADAS:
------------------------------
Ruby Style Guide:
    - snake_case para métodos y variables
    - CamelCase para clases y módulos
    - SCREAMING_SNAKE_CASE para constantes
    - ? suffix para predicados (empty?)
    - ! suffix para mutadores (save!)

Documentación:
    - RDoc format
    - YARD annotations

MÉTRICAS ESPECÍFICAS DE RUBY:
----------------------------
- Block usage
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.ruby_analyzer import RubyAnalyzer
    >>>
    >>> analyzer = RubyAnalyzer()
    >>> metrics = analyzer.analyze_file("app.rb", source_code)
