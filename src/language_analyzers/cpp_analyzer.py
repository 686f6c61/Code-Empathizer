...
"""
=============================================================================
Analizador de Código C++ - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código C++ utilizando expresiones
regulares para detectar patrones y características modernas de C++.

EXTENSIONES SOPORTADAS:
----------------------
- .cpp, .cc, .cxx - Archivos fuente C++
- .hpp, .h, .hh   - Archivos de cabecera

CARACTERÍSTICAS DE C++ ANALIZADAS:
---------------------------------
Moderno C++ (C++11/14/17/20):
...
----------------------
Nombres (Google C++ Style Guide):
    - CamelCase para clases y tipos
    - snake_case o camelCase para funciones
    - kConstantName para constantes
    - member_ o m_ para miembros privados
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.cpp_analyzer import CppAnalyzer
    >>>
    >>> analyzer = CppAnalyzer()
    >>> metrics = analyzer.analyze_file("main.cpp", source_code)
