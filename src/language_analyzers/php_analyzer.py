...
"""
=============================================================================
Analizador de Código PHP - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código PHP utilizando expresiones
regulares para detectar patrones y características modernas del lenguaje.

EXTENSIONES SOPORTADAS:
----------------------
- .php         - Archivos PHP estándar
- .php3/4/5    - Versiones específicas
- .phtml       - Plantillas PHP

CARACTERÍSTICAS DE PHP ANALIZADAS:
---------------------------------
Moderno PHP (7.x/8.x):
    - Type declarations
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.php_analyzer import PHPAnalyzer
    >>>
    >>> analyzer = PHPAnalyzer()
    >>> metrics = analyzer.analyze_file("index.php", source_code)
