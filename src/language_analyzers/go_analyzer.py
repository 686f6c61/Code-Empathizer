...
"""
=============================================================================
Analizador de Código Go - Basado en Regex
=============================================================================

Este módulo implementa un analizador para código Go (Golang) utilizando
expresiones regulares para detectar patrones idiomáticos del lenguaje.

EXTENSIONES SOPORTADAS:
----------------------
- .go - Archivos fuente de Go

CARACTERÍSTICAS DE GO ANALIZADAS:
--------------------------------
Estructura:
    - Packages
    - Functions y methods
...
CONVENCIONES DE GO EVALUADAS:
----------------------------
Nombres (Effective Go):
    - MixedCaps o mixedCaps (no underscores)
    - Exports: PascalCase (públicos)
    - Internos: camelCase (privados)
    - Acrónimos: URL, HTTP (no Url, Http)

Documentación:
    - Comments antes de declarations
    - Package comments
    - godoc format
...
EJEMPLO DE USO:
--------------
    >>> from language_analyzers.go_analyzer import GoAnalyzer
    >>>
    >>> analyzer = GoAnalyzer()
    >>> metrics = analyzer.analyze_file("main.go", source_code)
